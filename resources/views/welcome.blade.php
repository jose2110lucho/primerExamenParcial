...
<head>
    ...
    <title>UMLDiagramador</title>
    <meta content="" name="descriptison">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('assets/img/UML_icon.png') }}" rel="icon">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
                    <img src="{{asset('back/static/components/diagrama_icon.png')}}" width="1000" height="400">
                </div>
            </div>
        </div>
